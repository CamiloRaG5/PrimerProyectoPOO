...
public interface ICitaRepositorio {
     ...
     * @return Un Optional que contiene la cita si se encuentra, o un Optional vacío si no.
     */
     ...
     * @return true si existe una cita duplicada o solapada, false en caso contrario.
     */
